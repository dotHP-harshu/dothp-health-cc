# **DotHP Health Companion \- Disease Prediction and Recommendation System**
...
This project was developed by Harsh Prajapati, the development involved expertise in:

- **Machine Learning:** Model training, evaluation, and integration.

- **Web Development:** Frontend (HTML, CSS, JavaScript) and Backend (Flask, Python) development.

- **Data Management:** Handling and processing various datasets.
